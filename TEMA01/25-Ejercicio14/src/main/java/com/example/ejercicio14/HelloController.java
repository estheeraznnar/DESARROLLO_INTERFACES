...
public class HelloController {
    ...
    // Ventana secundaria (Stage) para mostrar tablas u otros datos
    ...
    private void initialize(){
        ...
        try {
            ...
            // Si hay registros, muestra el primero en los campos de texto
            if (rs.next()) {
    ...
    // Botón/metodo para ir al primer registro
    @FXML
    ...
    // Botón/metodo para ir al último registro
    @FXML
    ...
    //para avanzar al siguiente registro (si no es el último)
    @FXML
    private void derecha(){
        try {
            if (rs.next()){
                ...
                // Alerta si ya estamos en el último registro
    ...
    // para retroceder al registro anterior (si no es el primero)
    @FXML
    private void setIzq(){
        try {
            if (rs.previous()){
                ...
                // Alerta si ya estamos en el primer registro
                Alert alert = new Alert(Alert.AlertType.INFORMATION);
                alert.show();
                alert.setTitle("Error");
                alert.setHeaderText("Error");
    ...
    //Para guardar una nueva pieza en la base de datos
    @FXML
    private void setBtnGuardar(){
        try {
            ...
            ps.executeUpdate();
            // Refresca el ResultSet después de insertar
            stat = con.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,
                    ResultSet.CONCUR_READ_ONLY);
    ...
    //para limpiar los campos de texto (preparar para añadir una nueva pieza)
    @FXML
    ...
    // para mostrar una nueva ventana con información en una tabla
    @FXML
