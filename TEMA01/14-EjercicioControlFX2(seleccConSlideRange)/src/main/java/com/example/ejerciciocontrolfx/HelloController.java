...
public class HelloController {
    ...
    protected void initialize(){
        ...
        String user = "root";
        String clave = "1234";
        // Enlaza las columnas con los atributos del modelo Capitales
        ...
        try {
            ...
            // Recupera el mínimo y máximo de población para el slider
            int min = 0;
            int max = 0;
            ...
            // Configura el slider de rango para los valores de población disponibles
            slider.setMax(max);
            slider.setMin(min);
            slider.setMajorTickUnit(1000000);
            slider.setHighValue(max);
            slider.setLowValue(min);
            slider.setShowTickLabels(true);// Muestra etiquetas en el slider
            slider.setShowTickMarks(true); // Muestra marcas de intervalos en el slider
    ...
    // Al seleccionar una autonomía del combo, muestra solo esas capitales
    @FXML
    private void setCombo(){
        ...
        try {
            ...
            while (rs.next()) {
                ...
                autonomia.setCellValueFactory(new PropertyValueFactory<>("Autonomía"));
                poblacion.setCellValueFactory(new PropertyValueFactory<>("Población"));
                // Asegúrate de respetar el orden del constructor Capitales
    ...
    // Al mover el slider, filtra la tabla para
    // mostrar solo las capitales dentro del rango seleccionado de población
    @FXML
